...
/**
 * Class represents Options event execute visitable class.
 * @author Szymon Jablonski
 * @version 1.0
 */
public class ExecuteOptions extends ExecuteClass
{
	/**Game Model object */
	private Model model;
	/**Game View object */
	...
	/**
	 * Method used to execute Display options event.
	 */
	public void executeDisplayOptions()
	{
		  SwingUtilities.invokeLater(new Runnable() 
		  {
			  public void run() 
			  {
				  view.displayOptionsView();
