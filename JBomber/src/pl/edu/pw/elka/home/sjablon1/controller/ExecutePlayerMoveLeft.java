...
/**
 * Class represents PlayerMoveLeft event execute visitable class.
 * @author Szymon Jablonski
 * @version 1.0
 */
public class ExecutePlayerMoveLeft extends ExecuteClass
{
	/**Game Model object */
	private Model model;
	/**Game View object */
	...
	public void changeDestination()
	{
		...
		{
			this.getModel().setPlayerActualDestination(Destination.Left);
			this.getModel().setPlayerActualDestinationVertex(actualPosition.getLeftDestination());
		...
		if(actualPosition == null && actualDestination == Destination.Right)
		{
			...
			this.getModel().setPlayerActualDestination(Destination.Left);
			this.getModel().setPlayerActualDestinationVertex(destination.getLeftDestination());
	...
	public boolean checkMovingOppositeSide()
	{
		return (this.getView().isPlayerMoving() && 
				this.getModel().getPlayerActualDestination() == Destination.Right);
	}
