...
/**
 * Class represents CreditsEvent execute visitable class.
 * @author Szymon Jablonski
 * @version 1.0
 */
public class ExecuteCredits extends ExecuteClass
{
	/**Game Model object */
	private Model model;
	/**Game View object */
	...
	/**
	 * Method used to execute display Credits.
	 */
	public void executeDisplayCredits()
	{
		  SwingUtilities.invokeLater(new Runnable() 
		  {
			  public void run() 
			  {
				  view.displayCreditsView();
