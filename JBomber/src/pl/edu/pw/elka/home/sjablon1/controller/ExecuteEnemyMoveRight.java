...
/**
 * Class represents EnemyMoveRight event execute visitable class.
 * @author Szymon Jablonski
 * @version 1.0
 */
public class ExecuteEnemyMoveRight extends ExecuteClass
{
	/**Game Model object */
	 private Model model;
	/**Game View object */
	...
	public void changeDestination()
	{
		...
		{
			this.getModel().setEnemyActualDestination(Destination.Right);
			this.getModel().setEnemyActualDestinationVertex(actualPosition.getRightDestination());
		...
		if(actualPosition == null && actualDestination == Destination.Left)
		{
			...
			this.getModel().setEnemyActualDestination(Destination.Right);
			this.getModel().setEnemyActualDestinationVertex(destination.getRightDestination());
	...
	{
		return (this.getModel().getEnemyActualDestination() == Destination.Left);
	}
