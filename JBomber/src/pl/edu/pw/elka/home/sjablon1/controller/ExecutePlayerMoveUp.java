...
/**
 * Class represents PlayerMoveUp event execute visitable class.
 * @author Szymon Jablonski
 * @version 1.0
 */
public class ExecutePlayerMoveUp extends ExecuteClass
{
	/**Game Model object */
	private Model model;
	/**Game View object */
	...
	public void changeDestination()
	{
		...
		{
			this.getModel().setPlayerActualDestination(Destination.Up);
			this.getModel().setPlayerActualDestinationVertex(actualPosition.getUpDestination());
		...
		if(actualPosition == null && actualDestination == Destination.Down)
		{
			...
			this.getModel().setPlayerActualDestination(Destination.Up);
			this.getModel().setPlayerActualDestinationVertex(destination.getUpDestination());
	...
	{
		return (this.getModel().getPlayerActualDestination() == Destination.Down);
	}
