...
/**
 * Class represents PlayerMoveRight event execute visitable class.
 * @author Szymon Jablonski
 * @version 1.0
 */
public class ExecutePlayerMoveRight extends ExecuteClass
{
	/**Game Model object */
	private Model model;
	/**Game View object */
	...
	public void changeDestination()
	{
		...
		{
			this.getModel().setPlayerActualDestination(Destination.Right);
			this.getModel().setPlayerActualDestinationVertex(actualPosition.getRightDestination());
		...
		if(actualPosition == null && actualDestination == Destination.Left)
		{
			...
			this.getModel().setPlayerActualDestination(Destination.Right);
			this.getModel().setPlayerActualDestinationVertex(destination.getRightDestination());
	...
	public void updateAnimationSpriteData()
	{
		SwingUtilities.invokeLater(new Runnable() 
		{
			public void run() 
			{
				view.setPlayerAnimationDestination(8, 0);
	...
	{
		return (this.getModel().getPlayerActualDestination() == Destination.Left);
	}
