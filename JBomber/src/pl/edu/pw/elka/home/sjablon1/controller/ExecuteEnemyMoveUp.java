...
/**
 * Class represents EnemyMoveUp event execute visitable class.
 * @author Szymon Jablonski
 * @version 1.0
 */
public class ExecuteEnemyMoveUp extends ExecuteClass
{
	/**Game Model object */
	private Model model;
	/**Game View object */
	...
	public void changeDestination()
	{
		...
		{
			this.getModel().setEnemyActualDestination(Destination.Up);
			this.getModel().setEnemyActualDestinationVertex(actualPosition.getUpDestination());
		...
		if(actualPosition == null && actualDestination == Destination.Down)
		{
			...
			this.getModel().setEnemyActualDestinationVertex(destination.getUpDestination());
	...
	{
		return (this.getModel().getEnemyActualDestination() == Destination.Down);
	}
