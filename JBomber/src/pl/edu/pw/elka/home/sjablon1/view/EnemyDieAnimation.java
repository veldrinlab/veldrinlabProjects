...
/**
 * Class represents die animation of main animating object in Game, the Enemy Animation. Enemy die
...
{
	/**
	 * Default constructor of EnemyDieAnimation object.
	 * 
	 * @param EnemySpriteScheetFileName name of file contains animation SpriteSheet
	 */
	public EnemyDieAnimation(final String EnemySpriteScheetFileName)
	{
