...
/**
 * Class represents OptionsView object where user can change game configurations like
 * GameBoard Tile, number of players, audio options etc.
...
public class OptionsView extends JFrame implements ActionListener
{
	...
	/**
	* Default constructor of OptionsView object.
	* 
	* @param blockingEventQueue is queue for event communications between, Model, View and
	* 		  Controller Unit.
	*/
	public OptionsView(ArrayBlockingQueue<GameEvent> blockingEventQueue)
	{
		super("JBomber::Options");
