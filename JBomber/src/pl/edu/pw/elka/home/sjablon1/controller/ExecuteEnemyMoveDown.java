...
/**
 * Class represents EnemyMoveDown event execute visitable class.
 * @author Szymon Jablonski
 * @version 1.0
 */
public class ExecuteEnemyMoveDown extends ExecuteClass
{
	/**Game Model object */
	private Model model;
	/**Game View object */
	...
	public void changeDestination()
	{
		...
		{
			this.getModel().setEnemyActualDestination(Destination.Down);
			this.getModel().setEnemyActualDestinationVertex(actualPosition.getDownDestination());
		...
		if(actualPosition == null && actualDestination == Destination.Up)
		{
			...
			this.getModel().setEnemyActualDestination(Destination.Down);
			this.getModel().setEnemyActualDestinationVertex(destination.getDownDestination());
	...
	public void updateAnimationSpriteData()
	{
		SwingUtilities.invokeLater(new Runnable() 
		{
			public void run() 
			{
				view.setEnemyAnimationDestination(0, 8);
	...
	{
		return (this.getModel().getEnemyActualDestination() == Destination.Up);
	}
