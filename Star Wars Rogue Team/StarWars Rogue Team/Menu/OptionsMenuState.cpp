/**
 * Definition of OptionsMenuState class.
 ...
 */
OptionsMenuState::OptionsMenuState(SDL_Color bgColor)
{
 ...
 * @return new state.
 */
IMenuState* OptionsMenuState::performAction()
{
 ...
 * @return new state.
 */
IMenuState* OptionsMenuState::changeStateUp()
{
 ...
 * @return new state.
 */
IMenuState* OptionsMenuState::changeStateDown()
{
 ...
 */
void OptionsMenuState::printMenuText(TTF_Font* font, SDL_Surface* screen)
{
	...
	y += 50;
	x += 13;
	displayOneText(font, screen, "Options", activeForeground, x, y);
	y += 50;
	x += 5;
