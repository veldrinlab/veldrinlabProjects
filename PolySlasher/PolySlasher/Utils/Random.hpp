...
public:
	 ...
	 * @return	random integer.
	 */
	int getInt(const int min, const int max) const 
	{
	 ...
	 * @return	random color.
	 */
	Color getColor(const Color& colorA, const Color& colorB) const
	{
	 ...
	 */
	Math::Vector3D getPointOnCircle(const float r = 1.0f) const
	{
